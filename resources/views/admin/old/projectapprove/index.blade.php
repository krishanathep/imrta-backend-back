        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Project Approved</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <!--
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach ($projectapprove as $list)
                    <tr>
                        <td>{{ $list->id }}</td>
                        ...
                        <td>{{ $list->project_date_sent }}</td>
                      <td>
                          <a class="btn btn-info" href="{{ route('admin-old-projectapprove.show',$list->id) }}"> <i class="far fa-eye"></i></a>
                          <a class="btn btn-primary disabled" href="#"><i class="far fa-edit"></i></a>
