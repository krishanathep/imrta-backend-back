							...
							<div class="col-12">
								<div style="float: left;">
									<button
										...
										onclick="window.location.href='admin-proposal-submission';"
						...
						<tbody>
							...
							<tr>
								...
								<td style="min-width: 240px;">
									<select
										class="form-control"
										onchange="StatusSelectChange( $(this), {{ $list->proposal_sub_id }} )"
									>
										@foreach ($rs_status as $status)
											<option
												value="{{ $status->type_status_id }}"
												@if( $status->type_status_id == $list->proposal_sub_status_id ) selected @endif
											>
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">ยื่นเสนองานวิจัย</h5>
...
<script>
	...
	function InfoShow(id){
		...
		$.ajax({
			type: "GET",
			url: "admin-proposal-submission/"+id,
			cache: false,
