...
@section('content')
    <div class="containe-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h3 style="font-family: KanitExtraLight; " class="mt-3 mb-3">แก้ไขป้ายแบนเนอร์</h3>
                </div>
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <form action="{{ route('admin-setting-banner.update', $banner->banner_id) }}" method='POST' enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" class="form-control datetimepicker-input" data-target="#reservationdate_start"value="{{ $banner->start_date }}"/>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="stop_date" type="text" class="form-control datetimepicker-input" data-target="#reservationdate_stop" value="{{ $banner->stop_date }}"/>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <img class="mt-3 mb-3" src="{{ asset($banner->banner_url) }}" width="200px">
                                      </div>
                                </div>   
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
